...
const fs = require('fs');
const axios = require('axios');// For reading binary files (if needed)
...
async function uploadToImgBB(input, expiration = 1296000) {
  ...
  try {
    ...
    const response = axios.post('https://api.imgbb.com/1/upload?key=84425c5a9e72b87e9abc7645b904eb33', {
      method: 'POST',
      body: form,
